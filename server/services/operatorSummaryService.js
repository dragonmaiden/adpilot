...
function buildScanSection(overview, settings) {
  return {
    ...
    intervalMinutes: settings.scheduler?.analysisIntervalMinutes ?? settings.scheduler?.scanIntervalMinutes ?? null,
    commerceIntervalMinutes: settings.scheduler?.scanIntervalMinutes ?? null,
    analysisIntervalMinutes: settings.scheduler?.analysisIntervalMinutes ?? settings.scheduler?.scanIntervalMinutes ?? null,
