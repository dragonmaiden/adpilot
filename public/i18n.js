...
const I18N = {
  ...
  'opt.activityHub':    { en: 'Meaningful AI state changes', kr: '의미 있는 AI 상태 변화' },
  'opt.activityHubDesc': { en: 'Approvals, expiries, executions, and new recommendation families stay here. Routine scan noise is pushed into the system rail.', kr: '승인, 만료, 실행, 새 제안 패밀리만 여기 남기고 루틴 스캔 잡음은 시스템 레일로 보냅니다.' },
  ...
  'optimizations.kpiActionNow': { en: 'Action Now', kr: '즉시 액션' },
  'optimizations.kpiBacklog': { en: 'Open Backlog', kr: '열린 백로그' },
  'optimizations.kpiFriction': { en: 'Decision Friction', kr: '결정 마찰' },
  'optimizations.kpiRepeatPressure': { en: 'Repeat Pressure', kr: '반복 압력' },
  'optimizations.kpiQuality': { en: 'AI Quality', kr: 'AI 품질' },
  'optimizations.queueKicker': { en: 'Action Center', kr: '액션 센터' },
  'optimizations.queueTitle': { en: 'Immediate queue', kr: '즉시 큐' },
  'optimizations.queueDesc': { en: 'Latest scan approvals and anything already awaiting a Telegram reply live here.', kr: '최신 스캔 승인 항목과 이미 텔레그램 응답 대기 중인 항목이 여기에 모입니다.' },
  'optimizations.backlogKicker': { en: 'Backlog', kr: '백로그' },
  'optimizations.backlogTitle': { en: 'Open unresolved families', kr: '열린 미해결 패밀리' },
  'optimizations.backlogDesc': { en: 'Older unresolved approvals are grouped into decision families so stale backlog is obvious.', kr: '오래된 미해결 승인을 의사결정 패밀리로 묶어 정체 백로그가 바로 보이게 합니다.' },
