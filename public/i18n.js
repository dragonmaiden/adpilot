...
const I18N = {
  ...
  'opt.activityHub':    { en: 'AI Activity & Outcomes', kr: 'AI 활동 및 결과' },
  'opt.activityHubDesc': { en: 'Recent scan runs and execution updates live here, while the suggestion archive stays below for deeper review.', kr: '최근 스캔 실행과 처리 결과는 여기에서 보고, 세부 제안 이력은 아래 아카이브에서 확인합니다.' },
  'opt.recentActivity': { en: 'Recent Agent Activity', kr: '최근 에이전트 활동' },
  'opt.archiveTitle':   { en: 'Suggestion Archive', kr: '제안 아카이브' },
