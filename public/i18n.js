...
const I18N = {
  ...
  'page.calendar':      { en: 'Summary', kr: '요약' },
  ...
  'overview.hourSubtitle': { en: 'Selected range', kr: '선택 범위' },
  ...
  'chart.orderWeekday':     { en: 'Orders & revenue by weekday', kr: '요일별 주문 및 매출' },
  'chart.hourVolume':       { en: 'Order Timing Distribution (KST)', kr: '주문 시간대 분포 (KST)' },
  'chart.netProfitMargin':  { en: 'Net Profit & Margin', kr: '순이익 및 마진' },
  'analytics.hero.margin':   { en: 'Margin', kr: '마진' },
  'analytics.hero.trueRoas': { en: 'ROAS', kr: 'ROAS' },
  'analytics.hero.runRate':  { en: 'Avg/day', kr: '일평균' },
  'analytics.hero.waiting':  { en: 'Waiting for data...', kr: '데이터 대기 중...' },
  'analytics.hero.latestWaiting': { en: 'Selected range: waiting for data.', kr: '선택 범위: 데이터 대기 중.' },
  ...
  'analytics.kpi.trueNetProfit': { en: 'Net Profit', kr: '순이익' },
  'analytics.waterfallTitle': { en: 'Profit Movement', kr: '수익 흐름' },
  'analytics.coverageWaiting': { en: 'Waiting for data...', kr: '데이터 대기 중...' },
  'calendar.sectionKicker':   { en: 'Summary', kr: '요약' },
  'calendar.sectionTitle':    { en: 'Select a date range to review profit', kr: '날짜 범위를 선택해 수익을 검토하세요' },
  'calendar.sectionNote':     { en: 'Calendar selection controls every chart below · KST', kr: '캘린더 선택 범위가 아래 모든 차트를 제어합니다 · KST' },
  ...
  'calendar.sankeyTitle':     { en: 'Profit Sankey', kr: '수익 Sankey' },
