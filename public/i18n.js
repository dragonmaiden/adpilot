...
const I18N = {
  ...
  'opt.activityHub':    { en: 'Recent owner-relevant changes', kr: '최근 소유자 관련 변화' },
  'opt.activityHubDesc': { en: 'Only fresh decisions, blocked paths, and recent resolutions stay here. Older history belongs in the archive below.', kr: '신선한 결정, 막힌 경로, 최근 해결만 여기에 남기고 오래된 이력은 아래 아카이브로 보냅니다.' },
  'opt.activityHubKicker': { en: 'Decision Flow', kr: '결정 흐름' },
  'opt.recentActivity': { en: 'Recent Agent Activity', kr: '최근 에이전트 활동' },
  'opt.archiveTitle':   { en: 'Deduped decision families', kr: '중복 제거된 의사결정 패밀리' },
  'opt.clusterKicker':  { en: 'Recommendation Clusters', kr: '추천 클러스터' },
  'opt.clusterDesc':    { en: 'Grouped by decision family so repeat pressure, stale backlog, and the latest reasoning are easy to read.', kr: '의사결정 패밀리 기준으로 묶어 반복 압력, 정체 백로그, 최신 사유를 쉽게 읽을 수 있습니다.' },
  ...
  'optimizations.sectionNote': { en: 'This page should separate decisions you can still take, paths that are blocked or stale, signals worth watching, and older history that should stop distracting you.', kr: '이 페이지는 아직 내릴 수 있는 결정, 막히거나 오래된 경로, 계속 볼 신호, 그리고 더 이상 방해하지 않아야 할 오래된 이력을 구분합니다.' },
  ...
  'optimizations.kpiBacklog': { en: 'Blocked / Stale', kr: '막힘 / 오래됨' },
  ...
  'optimizations.backlogDesc': { en: 'These items are shown for cleanup only. They should not be mistaken for live approvals.', kr: '이 항목들은 정리용으로만 표시됩니다. 라이브 승인으로 오해하면 안 됩니다.' },
  'optimizations.archiveKicker': { en: 'Archive & Diagnostics', kr: '아카이브 및 진단' },
  'optimizations.archiveTitle': { en: 'Deduped decision families and raw history', kr: '중복 제거 패밀리와 원시 이력' },
