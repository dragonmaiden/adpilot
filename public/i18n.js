...
const I18N = {
  ...
  'campaigns.intradayTitle': { en: 'Is today’s spend turning into profit fast enough?', kr: '오늘 지출이 충분히 빨리 이익으로 바뀌고 있나요?' },
  'campaigns.intradayDesc': { en: 'Cumulative spend and revenue track against contribution after ad spend so you can see whether today is paying back or just burning early.', kr: '누적 지출과 매출을 광고비 차감 후 기여이익과 함께 봐서 오늘이 회수 중인지, 아니면 초반 소진만 빠른지 바로 확인합니다.' },
  'campaigns.intradayConfidence': { en: 'Profit confidence', kr: '이익 신뢰도' },
  'campaigns.intradayLoading': { en: 'Loading intraday pace...', kr: '당일 페이스 불러오는 중...' },
  'campaigns.dailyContextKicker': { en: 'Daily Context', kr: '일별 맥락' },
  'campaigns.dailyContextTitle': { en: 'Recent spend and CAC context', kr: '최근 지출과 CAC 맥락' },
  'campaigns.dailyContextDesc': { en: 'Use this as the recent-days backdrop for today’s pacing, not as the main decision story.', kr: '이건 오늘 페이스를 보는 배경 맥락이지, 메인 결정 스토리는 아닙니다.' },
  ...
  'opt.clusterDesc':    { en: 'Open this only when you need audit detail, duplicate history, or the latest reasoning behind an older family.', kr: '감사 세부 내용, 중복 이력, 오래된 패밀리의 최신 사유가 필요할 때만 여세요.' },
  'opt.rawHistorySummary': { en: 'Raw per-scan history', kr: '원시 스캔 이력' },
  'optimizations.sectionKicker': { en: 'AI Operations', kr: 'AI 운영' },
  'optimizations.sectionTitle': { en: 'AI decisions that still matter', kr: '아직 의미 있는 AI 결정' },
  'optimizations.sectionNote': { en: 'Start at the top. If there is nothing to decide now, everything else here is cleanup, context, or research.', kr: '상단부터 보세요. 지금 결정할 것이 없다면 나머지는 정리, 맥락, 또는 연구입니다.' },
  ...
  'optimizations.heroWaitingBody': { en: 'Once the next refresh lands, this space will tell you what needs a decision, what is just cleanup, and what can safely wait.', kr: '다음 새로고침이 오면 이 영역이 결정이 필요한 것, 정리만 필요한 것, 기다려도 되는 것을 알려줍니다.' },
  ...
  'optimizations.kpiBacklog': { en: 'Cleanup', kr: '정리' },
  'optimizations.kpiFriction': { en: 'Watching', kr: '관찰 중' },
  'optimizations.kpiRepeatPressure': { en: 'Resolved (24h)', kr: '해결됨 (24시간)' },
  'optimizations.kpiQuality': { en: 'Recent Changes', kr: '최근 변화' },
  ...
  'optimizations.queueDesc': { en: 'Only fresh latest-scan approvals and active Telegram reply waits belong here.', kr: '최신 스캔 승인과 실제 텔레그램 응답 대기만 여기에 남습니다.' },
  'optimizations.backlogKicker': { en: 'Cleanup', kr: '정리' },
  'optimizations.backlogTitle': { en: 'Blocked or stale families', kr: '막히거나 오래된 패밀리' },
  'optimizations.backlogDesc': { en: 'These are cleanup items only. They should not steal attention from live decisions.', kr: '이것들은 정리용 항목일 뿐입니다. 라이브 결정보다 주의를 빼앗으면 안 됩니다.' },
  ...
  'opt.awaitingTelegram': { en: 'Blocked / Stale', kr: '막힘 / 오래됨' },
  'opt.advisoryOnly':   { en: 'Watching', kr: '관찰 중' },
